...
libraryDependencies += "org.apache.hadoop" % "hadoop-mapreduce-client-jobclient" % "3.2.1"
libraryDependencies += "org.apache.hadoop" % "hadoop-mapreduce-client-shuffle" % "3.2.1"
libraryDependencies += "org.apache.hadoop" % "hadoop-mapreduce-client-common" % "3.2.1"
